    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            Sort By: <select onchange="location = this.value;" class="form-control">
                    <option value="/product-merchant" selected>All Products</option>
                    @foreach ($prodCat as $item)
                    <option value="/product-merchant/{{$item->category}}/{{ $item->id }}" @if ($catID == $item->id){ selected } @endif>{{$item->category}}
                    </option>
                    @endforeach
                </select>
            <br/><br/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="postcode" class="form-control" onkeyup="number(event);"  onkeypress="return isNumberKey(event)" name="postcode"
                                                placeholder="" required />
                                        </div>
                                    </div>
                                </div>
