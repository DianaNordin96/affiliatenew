                                            ...
                                            <div class="row">
                                                ...
                                                <br />
                                                    <div style="text-align:center">
                                                        ...
                                                        <br />
                                                        <b>RM {{ $product->price_hq + $product->price_shogun + $product->price_damio}}</b>
                                                        <br />
                                                        <b style="color : blue">Comm : RM {{ $product->product_price - $product->price_hq - $product->price_shogun - $product->price_damio }} /each</b>
                                                    </div>
                                                </div>

                                                <div class="col-9">
                                                    <br />
                                                    <button type="button" class="btn btn-block btn-outline-info" onclick="window.location='{{ url('addToCartMerchant/'.$product->id) }}'"> Add to cart</button>
                                                </div>
                                                <div class="col-3">
                                                    <br />
