                                            ...
                                            <div class="row">
                                                ...
                                                <br />
                                                    <div style="text-align:center">
                                                        ...
                                                        <br />
                                                        <b>RM {{ number_format($product->price_hq + $product->price_shogun,2) }}</b>
                                                        <br />
                                                        <b style="color : blue">Comm : RM {{ number_format($product->product_price - $product->price_hq - $product->price_shogun,2) }} /each</b>
                                                    </div>
                                                </div>
