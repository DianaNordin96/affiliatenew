@inject('category', 'App\Http\Controllers\Damio\ManageStockController')
                                ...
                                <div class="new-arrival-product">
                                    <div class="new-arrivals-img-contnent">
                                        ...
                                        style="width:220px;height:250px; display: block; margin-left: auto; margin-right: auto;" 
                                            src="{{asset('imageUploaded/products/'.$cat->image.'')}}" />
                                    </div>
                                    ...
                                    <div class="row">
                                        <div style="margin: auto"><button style="color:white;" type="button" title="View"
                                                data-toggle="modal" onclick="location='/product-damio/{{$cat->category}}/{{ $cat->id }}'" class="btn btn-warning">View Products</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                @if (session('cart'))
                                    @foreach (session('cart') as $id => $details)
                                        ...
                                        <tr style="border-bottom: lightgrey  1px solid">
                                            ...
                                            src="{{asset('imageUploaded/productCat/'.$details['photo'].'')}}" 
