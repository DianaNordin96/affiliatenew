                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <select onchange="location = this.value;" class="btn btn-default">
                                                        <option value="/manageDownlineDamio/damio/{{ $user->id }}" @if ($user->role == 'damio'){ selected }
                                        @endif>Damio
                                        </option>
                                        <option value="/manageDownlineDamio/merchant/{{ $user->id }}" @if ($user->role == 'merchant'){ selected } @endif
                                            >Merchant</option>
                                        <option value="/manageDownlineDamio/dropship/{{ $user->id }}" @if ($user->role == 'dropship'){ selected } @endif
                                            >Dropship</option>
                                        </select>
                                        </td>
                                        </tr>
