                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select onchange="location = this.value;" class="btn btn-default">
                                                    ...
                                                    @endif
                                                    <option value="/manageDownlineDamio/merchant/{{ $user[0]->id }}" @if($user[0]->role == 'merchant') selected @endif>Merchant</option>
                                                    <option value="/manageDownlineDamio/dropship/{{ $user[0]->id }}" @if($user[0]->role == 'dropship') selected @endif >Dropship</option>
                                                </select>
                                            </td>
                                            <td>
