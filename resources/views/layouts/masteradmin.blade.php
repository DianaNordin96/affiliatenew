                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/MasterDashboard">Go to Dashboard</a></li>
                        </ul>
                    </li>
                    <li class="nav-label">Manage Data</li>

                    <li><a title="Agents" class="ai-icon" href="/master-viewAgent" aria-expanded="false">
                    ...
                    <li><a title="Manage Commission" class="ai-icon" href="/master-commission" aria-expanded="false">
                        <i class="lni lni-wallet"></i> <span class="nav-text">Manage Commission</span>
                    </a>
                </li>
