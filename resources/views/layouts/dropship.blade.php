@inject('customer', 'App\Http\Controllers\Dropship\CustomerController')
<!doctype html>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div style="text-align:center">
                                            ...
                                            <br/><br/>
                                            <a class="btn btn-warning" style="color:black; width:100%" href="/dropship-cart">Click here to edit your cart</a>
                                        </div>
                                        ...
                                        <form action="{{ url('checkout-dropship') }}" method="POST">
                                            @csrf
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="/profile-dropship" role="button" data-toggle="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="/profile-dropship" class="dropdown-item ai-icon">
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/DropshipDashboard">Go to Dashboard</a></li>
                        </ul>
                    </li>
                    <li class="nav-label">Manage Data</li>

                    <li><a title="Customers" class="ai-icon" href="/customers-dropship" aria-expanded="false">
                            <i class="lni lni-customer"></i>
                            <span class="nav-text">Customers</span>
                        </a>
                    </li>

                    <li><a title="Buy Product" class="ai-icon" href="/product-dropship" aria-expanded="false">
                            <i class="lni lni-shopify"></i>
                            <span class="nav-text">Buy Product</span>
                        </a>
                    </li>

                    <li><a title="Purchase History" class="ai-icon" href="/purchase-history-dropship" aria-expanded="false">
