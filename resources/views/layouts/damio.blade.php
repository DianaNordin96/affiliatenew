@inject('customer', 'App\Http\Controllers\Damio\CustomerController')
<!doctype html>
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="/DamioDashboard" class="brand-logo">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div style="text-align:center">
                                            ...
                                            <br/><br/>
                                            <a class="btn btn-warning" style="color:black; width:100%" href="/damio-cart">Click here to edit your cart</a>
                                        </div>
                                        ...
                                        <form action="{{ url('checkout-damio') }}" method="POST">
                                            @csrf
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="/profile-damio" role="button" data-toggle="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="/profile-damio" class="dropdown-item ai-icon">
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/DamioDashboard">Go to Dashboard</a></li>
                        </ul>
                    </li>
                    <li class="nav-label">Manage Data</li>

                    <li><a title="Downline Agent" class="ai-icon" href="/downline-damio" aria-expanded="false">
                            <i class="lni lni-users"></i>
                            <span class="nav-text">Downline Agent</span>
                        </a>
                    </li>

                    <li><a title="Customers" class="ai-icon" href="/customers-damio" aria-expanded="false">
                            <i class="lni lni-customer"></i>
                            <span class="nav-text">Customers</span>
                        </a>
                    </li>

                    <li><a title="Buy Product" class="ai-icon" href="/product-damio" aria-expanded="false">
                            <i class="lni lni-shopify"></i>
                            <span class="nav-text">Buy Product</span>
                        </a>
                    </li>

                    <li><a title="Purchase History" class="ai-icon" href="/purchase-history-damio" aria-expanded="false">
                            <i class="lni lni-list"></i> <span class="nav-text">Purchase History</span>
                        </a>
                    </li>

                    <li><a title="Commission" class="ai-icon" href="/commission-damio" aria-expanded="false">
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by A/D Design</a>
                    2021</p>
            </div>
        </div>
        <!--**********************************
