                                            ...
                                            <div class="row">
                                                ...
                                                <br />
                                                    <div style="text-align:center">
                                                        ...
                                                        <br />
                                                        <b>RM
                                                            {{ number_format($product->price_hq + $product->price_shogun + $product->price_damio + $product->price_merchant, 2) }}</b>
                                                        <br />
                                                        <b style="color : blue">Commission : RM
                                                            {{ $product->product_price - $product->price_shogun - $product->price_hq - $product->price_damio - $product->price_merchant }}
                                                            /each</b>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-9">
                                                    <br />
                                                    <button type="button" class="btn btn-block btn-outline-info" onclick="window.location='{{ url('addToCartDropship/'.$product->id) }}'"> Add to cart</button>
                                                </div>
                                                <div class="col-3">
                                                    <br />
