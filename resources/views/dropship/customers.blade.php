                                        ...
                                        <tr>
                                            ...
                                            <td><button type="button" id="buttonEdit" title="Edit" data-toggle="modal"
                                                ...
                                                <button type="button" id="buttonEdit" title="Edit" data-toggle="modal"
                                                    onclick="window.location.href='customers-dropship-delete/{{ $customer->id }}'"
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ url('customers-dropship-add') }}" method="post"
        ...
        <div class="modal fade" id="modalEdit">
            <div class="modal-dialog modal-md modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ url('customers-dropship-update') }}" method="post"
                            enctype="multipart/form-data">
                            @csrf
