...
class ProfileController extends Controller
{
    ...
    public function update(Request $req)
    {
        ...
        if ($validator->fails()) {
            ...
            return redirect('/profile-dropship')->with('error', 'Please ensure all fields were filled and file uploaded is image files.');
        } else {
            $data = $req->input();
            try {
                if ($req->file('image') == null) {
                    ...
                    return redirect('/profile-dropship')->with('success', 'User has been updated');
                } else {
                ...
                return redirect('/profile-dropship')->with('error', 'Something went wrong');
            }
        }
    }
        ...
        if ($validator->fails()) {
            ...
            try {
                if ($req->password1 == $req->password2) {
                    ...
                    return redirect('/profile-dropship')->with('error','Your password has been updated');
                } else {
