...
(function($) {
    ...
    if (jQuery('#barChart_3').length > 0) {
        ...
        barChart_3gradientStroke.addColorStop(0, "rgba(58, 122, 254, 1)");
        barChart_3gradientStroke.addColorStop(1, "rgba(58, 122, 254, 0.5)");

        const barChart_3gradientStroke2 = barChart_3.createLinearGradient(50, 100, 50, 50);
        barChart_3gradientStroke2.addColorStop(0, "rgba(254, 176, 25, 1)");
        barChart_3gradientStroke2.addColorStop(1, "rgba(254, 176, 25, 1)");
    ...
    if (jQuery('#lineChart_2').length > 0) {
        ...
        new Chart(lineChart_2, {
            ...
            data: {
                ...
                datasets: [{
                    label: "My First dataset",
                    data: [25, 20, 60, 41, 66, 45, 80, 21, 26, 74, 29, 150],
    ...
    if (jQuery('#lineChart_3').length > 0) {
        ...
        lineChart_3gradientStroke1.addColorStop(0, "rgba(58, 122, 254, 1)");
        lineChart_3gradientStroke1.addColorStop(1, "rgba(58, 122, 254, 0.5)");

        const lineChart_3gradientStroke2 = lineChart_3.createLinearGradient(500, 0, 100, 0);
        lineChart_3gradientStroke2.addColorStop(0, "rgba(254, 176, 25, 1)");
        lineChart_3gradientStroke2.addColorStop(1, "rgba(254, 176, 25, 1)");
        ...
        new Chart(areaChart_1, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    borderWidth: "1",
                    backgroundColor: 'rgba(58, 122, 254, .5)',
            ...
            data: {
                ...
                datasets: [{
                    ...
                    },
                    {
                        ...
                        borderWidth: "1",
                        backgroundColor: 'rgba(254, 176, 25, .5)'
                    }
                ]
            },
            options: {
